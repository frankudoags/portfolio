...
const AboutMe = () => {
  ...
  return (
    <div ref={containerRef} id="about" className="bg-off-white">
      ...
      <div className="h-[2px] mx-8 lg:mx-16 bg-black line horizontal"></div>

      <div className="grid grid-cols-[1fr,_2px,_0.5fr] gap-16 py-16 overflow-hidden bg-white">
        <h1 className="text-9xl flex gap-4 lg:gap-8 text-[2.5rem] md:text-[4rem] lg:text-[6rem] font-semibold marquee">
          <span>Work</span> <span>Work</span> <span>Work</span>{" "}
          <span>Work</span> <span>Work</span> <span>Work</span>{" "}
          <span>Work</span> <span>Work</span> <span>Work</span>{" "}
          <span>Work</span> <span>Work</span> <span>Work</span>{" "}
          <span>Work</span>
